...
- 🏗 **ĐẠI TU RENDER & THIẾT KẾ (Jun 2026, máy Windows, kế hoạch `KE_HOACH_NANG_CAP_RENDER.md` ở repo chính C:\Users\Admin\VideoSystem)** — làm tuần tự 6 phase trên worktree `modest-mahavira-0b3db5`:
  ...
  - ⏭ Phase 1 content-graph → Phase 2 Design Director/token → Phase 3 EngineAdapter/tốc độ/cost-guard → Phase 4 studio → Phase 5 tự động hoá. Checkpoint cần Tommy: push main, scp VPS, RENDER_LIVE.
