/**
 * fetch-source — VENDORED từ nexu-io/html-video (Apache-2.0), giữ NGUYÊN VẸN.
 * Nguồn: packages/cli/src/fetch-source.ts @ commit 90a036a2f1ca1f91ccbffcf833f2e4ca8699f27b
 * License + attribution: xem THIRD_PARTY.md.
 *
 * Vai trò trong VideoSystem (Phase 4): "dán link/bài → video" — URL bài viết /
 * GitHub repo → Markdown sạch (CÓ CHẶN SSRF: localhost/private-IP/link-local bị
 * từ chối) → đẩy vào Scripter làm source brief.
 */
/**
