/**
 * content-graph — VENDORED từ nexu-io/html-video (Apache-2.0), giữ NGUYÊN VẸN.
 * Nguồn: packages/content-graph/src/index.ts @ commit 90a036a2f1ca1f91ccbffcf833f2e4ca8699f27b
 * License + attribution: xem THIRD_PARTY.md ở gốc repo. KHÔNG sửa logic file này
 * (cần mở rộng → viết module riêng import từ đây) để dễ đồng bộ upstream.
 *
 * Vai trò trong VideoSystem: xương sống storyboard nhiều cảnh — Scripter sinh
 * ContentGraph, scene-planner topoSort ra thứ tự cảnh + totalDurationSec ra timing.
 */
/**
