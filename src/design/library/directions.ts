/**
 * directions — VENDORED từ nexu-io/open-design (Apache-2.0), giữ NGUYÊN VẸN.
 * Nguồn: packages/contracts/src/prompts/directions.ts @ commit 1eac8fcabf20bbc585b8140f1cb6b92bd86f5876
 * License + attribution: xem THIRD_PARTY.md ở gốc repo.
 *
 * Vai trò trong VideoSystem: 5 hướng thẩm mỹ (palette OKLch + font + posture) —
 * input cho Design Director chọn hướng + đẻ BrandKit token (Phase 2).
 */
/**
